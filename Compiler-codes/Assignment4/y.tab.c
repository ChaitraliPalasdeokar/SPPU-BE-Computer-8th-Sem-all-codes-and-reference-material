...
{
  "$end", "error", "$undefined", "COMMA", "ID", "BUILTIN", "SC", "RP",
  "LP", "$accept", "var", "EXP", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 11 "var.y" /* yacc.c:1646  */
    {flag=1;}
#line 1209 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 13 "var.y" /* yacc.c:1646  */
    {flag =1;}
